...
public:
    ...
    int maxSatisfaction(vector<int>& satisfaction) {
        ...
        // int finalAns = solve(satisfaction, index, time);
        // return finalAns;
        ...
        // sort(satisfaction.begin(), satisfaction.end());
        // int finalAns = solveMem(satisfaction, index, time, dp);
        // return finalAns;

        // Method 3: Tabulation
        // sort(satisfaction.begin(), satisfaction.end());
        // int finalAns = solveTab(satisfaction);
        // return finalAns;

        // Method 4: Space Optimization
        // sort(satisfaction.begin(), satisfaction.end());
        // int finalAns = solveSO(satisfaction);
        // return finalAns;
    }
};
