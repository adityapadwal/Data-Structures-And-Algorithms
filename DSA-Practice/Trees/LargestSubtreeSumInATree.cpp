...
Question: Largest subtree sum in a tree (GfG)
...
class Solution {
  public:
    ...
    int findLargestSubtreeSum(Node* root)
    {
        ...
        int leftAns = findLargestSubtreeSum(root->left);
        int rightAns = findLargestSubtreeSum(root->right);
        
        m = max(m, leftAns+rightAns+root->data);
